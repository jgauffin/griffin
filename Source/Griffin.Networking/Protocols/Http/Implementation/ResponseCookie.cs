...
namespace Griffin.Networking.Protocols.Http.Implementation
{
    ...
    public class ResponseCookie : HttpCookie, IResponseCookie
    {
        ...
        public ResponseCookie(HttpCookie cookie, DateTime expires)
        ...
        {
            string temp = string.Format("{0}={1}; ", Uri.EscapeUriString(Name), Uri.EscapeUriString(Value));
